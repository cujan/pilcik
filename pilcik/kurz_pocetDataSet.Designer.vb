...
Partial Public Class kurz_pocetDataSet
    ...
    Partial Public Class kurzDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddkurzRow(ByVal nazov As String, ByVal zaciatok_kurzu As Date, ByVal koniec_kurzu As Date, ByVal typ As String, ByVal miesto_konania As String, ByVal pocet As Integer, ByVal cislo_protokolu As String, ByVal typ1 As Integer, ByVal typ_nazov As String) As kurzRow
            Dim rowkurzRow As kurzRow = CType(Me.NewRow,kurzRow)
            Dim columnValuesArray() As Object = New Object() {nazov, zaciatok_kurzu, koniec_kurzu, typ, miesto_konania, pocet, Nothing, cislo_protokolu, typ1, typ_nazov}
...
Namespace kurz_pocetDataSetTableAdapters
    ...
    Partial Public Class kurzTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlServerCe.SqlCeCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT     COUNT(clenovia_kurzu.kurz_id) AS pocet, kurz.nazov, kurz.zaciatok_kurz"& _ 
                "u, kurz.koniec_kurzu, kurz.typ, kurz.miesto_konania, kurz.id, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                "& _ 
                "      kurz.cislo_protokolu, c_typ_kurzu.nazov AS typ_nazov"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         kurz LE"& _ 
                "FT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      c_typ_kurzu ON kurz.typ = c_typ_kurzu.id LE"& _ 
                "FT OUTER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      clenovia_kurzu ON clenovia_kurzu.kurz_id = "& _ 
                "kurz.id"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"GROUP BY clenovia_kurzu.kurz_id, kurz.nazov, kurz.zaciatok_kurzu, kurz."& _ 
                "koniec_kurzu, kurz.typ, kurz.miesto_konania, kurz.id, kurz.cislo_protokolu, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  "& _ 
                "                    c_typ_kurzu.nazov"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
